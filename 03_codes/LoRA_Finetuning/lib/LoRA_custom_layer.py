...
from .LoRA_custom_config import LoraConfig
...
class LoraLayer(BaseTunerLayer):
    ...
    def __init__(self, base_layer: nn.Module, ephemeral_gpu_offload: bool = False, **kwargs) -> None:
        ...
        elif base_layer.__class__.__name__ == "VQuantLinear" and hasattr(base_layer, "in_features") and hasattr(base_layer, "out_features"):
            # VPTQ QuantLinear (VQuantLinear)
            in_features, out_features = base_layer.in_features, base_layer.out_features
